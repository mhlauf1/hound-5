        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-dark-brown/40 md:hidden"
              style={{top: 0}}
              onClick={closeMobile}
            />
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[85%] max-w-[360px] bg-light-tan z-50 md:hidden flex flex-col shadow-2xl"
            >
              {/* Drawer Header */}
